...
<body style="background-image: url('/images/hero.jpg');  background-size: cover;">
    ...
    <div class="p">
        ...
        <p><b>Email</b> : chillflixcsutomerservice@gmail.com</p>
        <br>
        <p><b>Customer service No. : 000-800-040-1843</b></p>
        <br>
        <p>Chilllix, Inc.</p>
        <p>100 Winchester Circle</p>
        <p>Los Gatos, CA 95032, USA</p>
        <br>
        <p>Chillflix International B.V.</p>
        <p>Stadhouderskade 55</p>
        <p>1072 AB Amsterdam, the Netherlands</p>
        <p>KvK: 62266519</p>
